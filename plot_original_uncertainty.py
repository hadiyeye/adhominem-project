...
# ===== uncertainty 区域（关键🔥）=====
plt.axvspan(l1, l2, alpha=0.25, label=f"Uncertainty [{l1:.2f}, {l2:.2f}]")
...
plt.ylabel("Count")
plt.title("Original: Prediction Distribution with Uncertainty")

plt.legend()
plt.tight_layout()

plt.savefig("results/original_uncertainty_plot.png", dpi=300)
plt.show()
